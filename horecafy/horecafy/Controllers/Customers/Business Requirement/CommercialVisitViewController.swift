//
//  CommercialVisitViewController.swift
//  horecafy
//
...
class CommercialVisitViewController: BaseViewController, CarbonTabSwipeNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        tabSwipe = CarbonTabSwipeNavigation(items: ["Agregar disponibilidad", "Notificaciones"], delegate: self)
    ...
    func carbonTabSwipeNavigation(_ carbonTabSwipeNavigation: CarbonTabSwipeNavigation, viewControllerAt index: UInt) -> UIViewController {
        ...
        if index == 0 {
            return self.storyboard!.instantiateViewController(withIdentifier: "SchedualSlotViewController")
        }
        return self.storyboard!.instantiateViewController(withIdentifier: "CustomerBussinessNotificationViewController")
    }
